<template>
  <v-card class="mx-3 mt-4">
    ...
    <v-row class='mx-3'>
        <v-col>
            <p>Want something in a different fabric or multiple colors or need a custom size?  We can do that too, please contact us for custom inquiries! </p>
        </v-col>
    </v-row>
    <v-row class='mx-3'>
        <v-col>
    ...
    <v-row class='mx-3'>
        <v-col>
            <p>Please note that these are custom crafted and ordered. Production time can take up to 4 weeks (but we always try to get them done quicker!).</p>
        </v-col>
    </v-row>
    <v-row class='mx-3'>
        <v-col>
    ...
    <v-row class='mx-3'>
        <v-col>
            <p>Please note that these are custom crafted and ordered. Production time can take up to 3 weeks (but we always try to get them done quicker!).</p>
        </v-col>
    </v-row>
    <v-row class='mx-3'>
        <v-col>
    ...
    <v-row class='mx-3'>
        <v-col>
            <p>Upon check out please specify preferred colors, crystals, and glitter. Please note that some crystals may be unavailable or rare, but we will do our best to match them as best we can! If you have images of your tail, costume, etc. please email them to us so we can use them for reference and color match.</p>
        </v-col>
    </v-row>
    <v-row class='mx-3'>
        <v-col>
            <p>Please note that these are custom crafted and ordered. Production time can take up to 2 weeks (but we always try to get them done quicker!).</p>
        </v-col>
    </v-row>
    <v-row class='mx-3'>
        <v-col>
    ...
    <v-row class='mx-3'>
        <v-col>
            <p>We also make our own mermaid tiaras, tops, and tails upon request. Please contact us if you would like to inquire about ordering something unique for your event or special day!</p>
        </v-col>
    </v-row>
  </v-card>
</template>
